                                    ...
                                    <#if authRole?? && authRole == 'ADMIN' >
                                        <#if leaf.value??>
                                            <a href="#" data-toggle="modal" class="href-select"
                                               ...
                                               itemprop="${leaf.strValue?html}">${leaf.name}</a>
                                        <#else>
                                            <a href="#" data-toggle="modal" class="href-select"
                                               data-target="#addPropertyModal" itemprop="">${leaf.name}</a>
                                        </#if>
                                    <#else>
                                        ${leaf.name}
                                    </#if>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <input type="submit" id="searchBtn" name="action" value="Search"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-addon">Name</span>
                                        <input type="text" id="newProperty" name="newProperty" class="form-control"
                                               placeholder="name">
                                    </div>
                                    <br/>
                                    <div class="input-group input-group-lg">
                                        <span class="input-group-addon">Value</span>
                                        <textarea id="newValue" name="newValue" class="form-control" placeholder="value"
                                                  style="resize:vertical;"></textarea>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                    <input type="submit" id="savePropertyBtn" name="action" value="Save Property"
                                           class="btn btn-primary"/>
                                    <input type="submit" id="updatePropertyBtn" name="action" value="Update Property"
                                           class="btn btn-primary"/>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <div class="checkbox text-left">
                                        <label><input type="checkbox" name="scmOverwrite" value="true"> Overwrite
                                            Existing Properties</label>
                                    </div>
